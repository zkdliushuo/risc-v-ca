...
module DataExtend(
    ...
    case (load_type)
        // 如果不是寄存器写指令，就设输出为0
        `NOREGWRITE:    dealt_data= 32'h00000000;
        // Load Byte
        `LB:            begin
                        case(addr)
        ...
        `LBU:           begin
                        case(addr)
                            2'b00:  dealt_data= { 24'h000000,data[7:0] };
                            2'b01:  dealt_data= { 24'h000000,data[15:8] };
                            2'b10:  dealt_data= { 24'h000000,data[23:16] };
                            2'b11:  dealt_data= { 24'h000000,data[31:24] };
                        endcase
                        end
        `LHU:           dealt_data= addr[1]? { 16'h0000,data[31:16] }: {16'h0000,data[15:0]};
        default:        dealt_data= 32'h00000000;
    endcase
	end
